...
const TopBar = () => {
  ...
  return (
    <div className="flex justify-between mb-4 pt-0  w-full ">
      <div className="bg-white center w-[66%]  h-14 p-3 px-4 rounded-xl ">
      ...
      <div className=" w-4/12  h-14 flex  justify-end gap-5">
        <div className="flex xl:gap-x-5 lg:gap-x-1   ">
          <img src={AvatarPic} alt="AvatarPic" className="aspect-square mx-" />
        ...
        <div className="bg-white p-4 between rounded-2xl   ">
